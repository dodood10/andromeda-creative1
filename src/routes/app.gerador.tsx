...
import { Wand2, Sparkles, ArrowRight, Brain, Loader2, Target, Gauge } from "lucide-react";
import { toast } from "sonner";
import { gerarAngulos, type ResultadoAngulos } from "@/lib/anthropic.functions";
...
function Gerador() {
  ...
  const [perguntaCirurgica, setPerguntaCirurgica] = useState("");
  ...
  async function handleGenerate() {
    ...
    try {
      const data = await run({
        data: { url, productType, goal, context, perguntaCirurgica, tomCalibracao },
      });
      setResultado(data);
    } catch (e) {
      console.error(e);
    ...
    <div className="container mx-auto px-6 py-8 max-w-6xl space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Cole a URL, calibre o briefing e gere 5 ângulos com lógica probabilística Andromeda 2026.
        </p>
      </div>
      ...
      <Card className="glass bg-gradient-card p-6">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            <Label>Pergunta cirúrgica respondida (opcional)</Label>
            <Textarea
              placeholder="Ex: maior dor reportada, micropersona-foco, vilão nomeado..."
              rows={2}
              value={perguntaCirurgica}
              onChange={(e) => setPerguntaCirurgica(e.target.value)}
            />
          </div>
        </div>
                ...
                <AccordionItem key={i} value={`a${i}`} className="glass bg-gradient-card rounded-xl px-5 border-0">
                  ...
                  <AccordionContent className="space-y-4 pt-3">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                      ...
                      <div className="p-3 rounded bg-background/40 border border-border/50 md:col-span-2">
                    ...
                    <div className="p-3 rounded bg-background/40 border border-border/50">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm">
                        ...
                        <div>
                          <div className="text-xs text-muted-foreground">Feedback negativo</div>
