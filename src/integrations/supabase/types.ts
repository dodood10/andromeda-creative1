  ...
  public: {
    Tables: {
      ...
      api_usage_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "api_usage_events_organization_id_fkey"
      ...
      criativo_admin_reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "criativo_admin_reviews_criativo_id_fkey"
            columns: ["criativo_id"]
            isOneToOne: false
      ...
      criativos: {
        Row: {
          ...
          source: Database["public"]["Enums"]["criativo_source"]
          status: Database["public"]["Enums"]["criativo_status"]
          status_rodando_at: string | null
        ...
        Insert: {
          ...
          estilo?: string
          estilo_producao?:
            | Database["public"]["Enums"]["estilo_producao"]
            | null
          export_paths?: Json | null
          export_status?: Database["public"]["Enums"]["export_status"] | null
          formato?: string
        ...
        Relationships: [
          {
            foreignKeyName: "criativos_geracao_id_fkey"
            columns: ["geracao_id"]
            isOneToOne: false
      ...
      geracoes: {
        ...
        Relationships: [
          {
            foreignKeyName: "geracoes_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "geracoes_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
      ...
      resultados_reportados: {
        ...
        Relationships: [
          {
            foreignKeyName: "resultados_reportados_criativo_id_fkey"
            columns: ["criativo_id"]
            isOneToOne: false
            referencedRelation: "criativos"
            referencedColumns: ["id"]
      ...
      video_render_jobs: {
        ...
        Relationships: [
          {
            foreignKeyName: "video_render_jobs_criativo_id_fkey"
            columns: ["criativo_id"]
            isOneToOne: false
            referencedRelation: "criativos"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      user_can_access_criativo_storage_path: {
        Args: { path: string }
        Returns: boolean
      }
    }
    Enums: {
      ...
      criativo_source: "andromeda" | "importado"
      criativo_status:
        | "Gerado"
        | "Subiu"
        | "Rodando"
